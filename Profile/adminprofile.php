...
<?php
    ...
    $q = mysqli_query($conn, "SELECT * FROM administrator WHERE a_id = '$aid'");
...
<div class="row">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="mb-3 col-md-6">
                              ...
                              <h4 id="name"><?php echo $row['a_name'];?></h4>
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                              ...
                              <h4 id="email"><?php echo $row['a_email'];?></h4>
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3 col-md-6">
    ...
    if (isset($_POST['btnCName'])) {
        ...
        $queryname = mysqli_query($conn, "UPDATE administrator SET a_name = '$name' WHERE a_id = '$aid'");
    ...
    if (isset($_POST['btnCPass'])){
        ...
        $querypass = mysqli_query($conn, "UPDATE administrator SET a_password = '$pass' WHERE a_id = '$aid'");
    ...
    if (isset($_POST['btnDeactivate'])){
        ...
        $queryd = "DELETE from administrator WHERE a_id = '$aid'";
