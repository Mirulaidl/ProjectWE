...
<?php
    ...
    $q = mysqli_query($conn, "SELECT * FROM unitkeselamatan WHERE uk_id = '$ukid'");
...
<div class="row">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="mb-3 col-md-6">
                              ...
                              <h4 id="name"><?php echo $row['uk_name'];?></h4>
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                              ...
                              <h4 id="email"><?php echo $row['uk_email'];?></h4>
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3 col-md-6">
    ...
    if (isset($_POST['btnCName'])) {
        ...
        $queryname = mysqli_query($conn, "UPDATE unitkeselamatan SET uk_name = '$name' WHERE uk_id = '$ukid'");
            ...
            echo '
                    <script type="text/javascript">
                        alert("Name have been updated!");
                          setTimeout(function(){
                            window.location.href="ukprofile.php";
                        },1000);
    ...
    if (isset($_POST['btnCPass'])){
        ...
        $querypass = mysqli_query($conn, "UPDATE unitkeselamatan SET uk_password = '$pass' WHERE uk_id = '$ukid'");
    ...
    if (isset($_POST['btnDeactivate'])){
        ...
        $queryd = "DELETE from unitkeselamatan WHERE uk_id = '$ukid'";
